...
<div class="page">
  <div class="card">
    ...
    <p class="subtitle">Join us to start predicting student performance</p>
    ...
    {#if submitted}
      <div class="success">Account created! (demo)</div>
    {/if}

    <p class="footer-text">
      Already have an account? <a href="/signin" class="link">Sign in</a>
    </p>
  </div>
</div>
